...
class CircularArrayTest < MiniTest::Unit::TestCase
  def circular_array
    CircularArray.new([0, 1, 2])
  end

  def test_regular_access
    assert_equal 0, circular_array[0]
    assert_equal 1, circular_array[1]
    assert_equal 2, circular_array[2]
  end

  def test_circular_access
    assert_equal 0, circular_array[3]
    assert_equal 1, circular_array[4]
    assert_equal 2, circular_array[5]
  end

  def test_negative_access
    assert_equal 2, circular_array[-1]
    assert_equal 1, circular_array[-2]
    assert_equal 0, circular_array[-3]
    assert_equal 2, circular_array[-4]
  end
end
